...
\fancypagestyle{plain}{
    ...
    \renewcommand{\headrulewidth}{0pt}
    \fancyhead[L]{
        \includegraphics[height = 12 mm]{/Users/dimitri.de-roeck/Tresorit/Images/Logos/Logo.PoPS.pdf}
    }

    \fancyhead[R]{
        \includegraphics[height = 12 mm]{/Users/dimitri.de-roeck/Tresorit/Images/Logos/Logo.UPS.pdf}
    }

    \fancyfoot[L] {
        \noindent\makebox[\textwidth]{\includegraphics[width=\paperwidth]{/Users/dimitri.de-roeck/Tresorit/Images/Logos/Lignes.png}}
    }
}
